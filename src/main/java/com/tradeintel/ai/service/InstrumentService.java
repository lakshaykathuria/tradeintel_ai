...
public class InstrumentService {
    ...
    private void loadHardcodedInstruments() {
        ...
        addInstrument("NSE_EQ|INE075A01022", "WIPRO", "Wipro Limited");
        ...
        addInstrument("NSE_EQ|INE364U01010", "ADANIGREEN", "Adani Green Energy Limited");
        addInstrument("NSE_EQ|INE910H01017", "ADANITRANS", "Adani Transmission Limited");
        addInstrument("NSE_EQ|INE752E01010", "POWERGRID", "Power Grid Corporation of India");
        addInstrument("NSE_EQ|INE733E01010", "NTPC", "NTPC Limited");
        addInstrument("NSE_EQ|INE213A01029", "ONGC", "Oil and Natural Gas Corporation");
        ...
        addInstrument("NSE_EQ|INE237A01036", "KOTAKBANK", "Kotak Mahindra Bank Limited");
        ...
        addInstrument("NSE_EQ|INE522F01014", "COALINDIA", "Coal India Limited");
        ...
        addInstrument("NSE_EQ|INE437A01024", "APOLLOHOSP", "Apollo Hospitals Enterprise Limited");
        addInstrument("NSE_EQ|INE018A01030", "LT", "Larsen and Toubro Limited");
        ...
        addInstrument("NSE_EQ|INE066A01021", "EICHERMOT", "Eicher Motors Limited");
        ...
        addInstrument("NSE_EQ|INE262H01021", "PERSISTENT", "Persistent Systems Limited");
        addInstrument("NSE_EQ|INE124L01009", "MPHASIS", "Mphasis Limited");
        addInstrument("NSE_EQ|INE205A01025", "VEDL", "Vedanta Limited");
        addInstrument("NSE_EQ|INE114A01011", "SAIL", "Steel Authority of India Limited");
        ...
        addInstrument("NSE_EQ|INE020B01018", "RECLTD", "REC Limited");
        addInstrument("NSE_EQ|INE134E01011", "PFC", "Power Finance Corporation Limited");
